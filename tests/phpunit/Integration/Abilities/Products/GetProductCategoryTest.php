<?php
/**
 * Integration tests for the wc-products/get-product-category ability.
 *
...
/**
 * Exercises wc-products/get-product-category: the shaped single-category term
...
final class GetProductCategoryTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$ability = wp_get_ability( 'wc-products/get-product-category' );

		$this->assertNotNull( $ability );
		$this->assertSame( 'wc-products/get-product-category', $ability->get_name() );
	}
	...
	public function test_admin_reads_category_detail(): void {
		...
		$result = wp_get_ability( 'wc-products/get-product-category' )->execute( array( 'id' => $id ) );
	...
	public function test_missing_category_returns_404_not_permission_error(): void {
		...
		$result = wp_get_ability( 'wc-products/get-product-category' )->execute( array( 'id' => 99999999 ) );
