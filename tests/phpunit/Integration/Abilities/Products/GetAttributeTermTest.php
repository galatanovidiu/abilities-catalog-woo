<?php
/**
 * Integration tests for the og-wc-products/get-attribute-term ability.
 *
...
/**
 * Exercises og-wc-products/get-attribute-term: the shaped single-term record, the
...
final class GetAttributeTermTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$ability = wp_get_ability( 'og-wc-products/get-attribute-term' );

		$this->assertNotNull( $ability );
		$this->assertSame( 'og-wc-products/get-attribute-term', $ability->get_name() );
	}
	...
	public function test_admin_reads_attribute_term_detail(): void {
		...
		$result = wp_get_ability( 'og-wc-products/get-attribute-term' )->execute(
			array(
