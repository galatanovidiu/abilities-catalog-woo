	...
	public function categories(): array {
		...
		return array(
			'og-wc-products'         => array(
				'slug'        => 'og-wc-products',
				'label'       => __( 'OG WooCommerce Products', 'abilities-catalog-woo' ),
			...
			'og-wc-orders'           => array(
				'slug'        => 'og-wc-orders',
				'label'       => __( 'OG WooCommerce Orders', 'abilities-catalog-woo' ),
			...
			'og-wc-customers'        => array(
				...
				'label'       => __( 'OG WooCommerce Customers', 'abilities-catalog-woo' ),
			...
			'og-wc-taxes'            => array(
				'slug'        => 'og-wc-taxes',
				'label'       => __( 'OG WooCommerce Taxes', 'abilities-catalog-woo' ),
