...
/**
 * Read ability: `wc-orders/get-order-refund`.
 *
 ...
 * with `wc-orders/list-order-refunds`.
 *
...
final class GetOrderRefund implements ConditionalAbility {
	...
	public function name(): string {
		return 'wc-orders/get-order-refund';
	}
			...
			'input_schema'        => array(
				...
				'properties'           => array(
					...
					'id'       => array(
						'type'        => 'integer',
						'minimum'     => 1,
						'description' => __( 'The refund ID, which must belong to order_id. Discover it with wc-orders/list-order-refunds.', 'abilities-catalog-woo' ),
					),
				),
